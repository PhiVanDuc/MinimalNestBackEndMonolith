...
module.exports = (data) => {
    return {
        subject: "Minimal Nest - Xác minh email",
        html: `
            <main style="font-family: Google Sans, Roboto, RobotoDraft, Helvetica, Arial, sans-serif;">
                <div style="margin: 0 auto; width: 100%; max-width: 600px;">
                    ...
                    <div style="padding: 30px; border: 1px #e0e0e0 solid; border-top: none; border-bottom: none; text-align: center;">
                        ...
                        <a href="${FE}/verify-email?token=${data.authToken}" target="_blank" style="display: inline-block; padding: 15px 25px; font-size: 15px; color: #ffffff; background-color: #12778A; border-radius: 5px; text-decoration: none; font-weight: 600;">
                            Xác minh email
                        </a>
                    </div>
