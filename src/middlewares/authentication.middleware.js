...
module.exports = (req, res, next) => {
    try {
        ...
        if (!accessToken || accessToken === "undefined") throwHttpError(401, "Không nhận được phiên đăng nhập phụ!");
        ...
        if (verified.isInvalid) throwHttpError(401, "Phiên đăng nhập phụ không hợp lệ!");
